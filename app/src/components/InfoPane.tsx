...
export default function InfoPane({ state }: InfoPaneProps): JSX.Element {
	return (
		<div className="max-w-[400px] mx-2">
			...
			<div className="rounded-2xl border-[1px] border-neutral-200 dark:border-neutral-700 px-4 my-4 bg-white dark:bg-zinc-800">
				...
				{ state.info.videoDetails.description && <div className="markdown-wrapper text-neutral-700 dark:text-neutral-400 border-t-[1px] border-neutral-200 dark:border-neutral-700 py-2 -mx-4 px-4">
