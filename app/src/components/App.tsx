	...
	return (
		<div className="grid w-full h-full bg-zinc-100 dark:bg-zinc-900 fixed">
			...
			<div className="flex w-full justify-center mt-12 pt-2 top-0 absolute flex-col h-full overflow-auto pb-12 items-center">
				...
				<div className={ classnames("transition-all mt-4 w-full", state === null || !state ? "h-0" : state && state.success ? "h-full overflow-auto" : "h-16 overflow-hidden") }>
					<div className="w-[1440px] sm:max-w-full md:max-w-[90%] lg:max-w-[80%] mx-auto max-w-full flex flex-wrap lg:flex-nowrap">
